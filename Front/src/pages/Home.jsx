...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#FCFDFC]">
      ...
      {/* Shop by Categories */}
      {homepage.categories && (
        <div id="shop-category" className="scroll-mt-24 sm:scroll-mt-44 w-full max-w-[1440px] mx-auto my-6 md:my-10 px-2 md:px-4">
      ...
      {homepage.essentials && (
        <div  id="essentials" className="scroll-mt-24 sm:scroll-mt-44 my-10 md:my-20">
      ...
      {homepage.bestSelling && (
        <div id="best-selling" className="scroll-mt-24 sm:scroll-mt-44 my-10 md:my-20">
          <ProductGrid 
